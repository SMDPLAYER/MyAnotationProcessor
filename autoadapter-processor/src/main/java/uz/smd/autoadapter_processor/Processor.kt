package uz.smd.autoadapter_processor

import uz.smd.autoadapter_processor.codegen.AdapterCodeBuilder
import uz.smd.autoadapter_processor.models.ModelData
import uz.smd.autoadapter_processor.models.ViewHolderBindingData
...
class Processor : AbstractProcessor() {
  ...
  override fun getSupportedAnnotationTypes() = mutableSetOf(AdapterModel::class.java.canonicalName)
